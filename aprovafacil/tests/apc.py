...
from aprovafacil.wrapper import APCWrapper
...
class TestFirstCharge(BaseFirstChargeTest):
    ...
    def test_erro_http(self):
        wrapper = APCWrapper(cgi_url=self.url)
        post_data = self.get_post_data()
        result = wrapper.do_post(**post_data)
    ...
    def test_autorizacao_recusada(self):
        ...
        result = wrapper.do_post(**post_data)
        self.assertFalse(result['approved'])
        self.assertEquals(result['failure_reason'], APCWrapper.FAILURE_REASONS['30'])
        self.assertEquals(
            post_data['NumeroCartao'][:6],
            result['CartaoMascarado'][:6]
        )
    ...
    def test_autorizacao_recusada_cartao_bloqueado(self):
        ...
        result = wrapper.do_post(**post_data)
        self.assertFalse(result['approved'])
        self.assertEquals(result['failure_reason'], APCWrapper.FAILURE_REASONS['78'])
    ...
    def test_autorizacao_recusada_cartao_invalido(self):
        ...
        result = wrapper.do_post(**post_data)
        self.assertFalse(result['approved'])
        self.assertEquals(result['failure_reason'], APCWrapper.FAILURE_REASONS['14'])
    ...
    def test_autorizacao_recusada_valor_invalido(self):
        ...
        result = wrapper.do_post(**post_data)
        self.assertFalse(result['approved'])
        self.assertEquals(result['failure_reason'], APCWrapper.FAILURE_REASONS['60'])
    ...
    def test_autorizacao_recusada_transacao_ja_efetuada(self):
        ...
        result = wrapper.do_post(**post_data)
        self.assertFalse(result['approved'])
        self.assertEquals(result['failure_reason'], APCWrapper.FAILURE_REASONS['68'])
    ...
    def test_autorizacao_recusada_cartao_vencido(self):
        ...
        result = wrapper.do_post(**post_data)
        self.assertFalse(result['approved'])
        self.assertEquals(result['failure_reason'], APCWrapper.FAILURE_REASONS['54'])
    ...
    def test_autorizacao_recusada_dados_invalidos(self):
        ...
        result = wrapper.do_post(**post_data)
        self.assertFalse(result['approved'])
        self.assertEquals(result['failure_reason'], APCWrapper.FAILURE_REASONS['56'])
    ...
    def test_autorizacao_recusada_codigo_seguranca_invalido(self):
        ...
        result = wrapper.do_post(**post_data)
        self.assertFalse(result['approved'])
        self.assertEquals(result['failure_reason'], APCWrapper.FAILURE_REASONS['N7'])
    ...
    def test_autorizacao_recusada_refaca_transacao(self):
        ...
        result = wrapper.do_post(**post_data)
        self.assertFalse(result['approved'])
        self.assertEquals(result['failure_reason'], APCWrapper.FAILURE_REASONS['84'])
...
class TestFirstChargeValidation(BaseFirstChargeTest):
    ...
    def test_quantidade_parcelas_negativa_gera_falha(self):
        ...
        self.assertRaises(ValueError, wrapper.do_post, **post_data)
